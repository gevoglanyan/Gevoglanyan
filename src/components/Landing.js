...
const Landing = () => {
  ...
  return (
    <section
      id="landing"
      className="relative min-h-screen flex flex-col justify-center items-center px-6 md:px-12 pt-20 md:pt-24 lg:pt-0 bg-black text-center"
    >
      <motion.div
      ...
      >
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold mb-6 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent pb-3">
          Harry Gevoglanyan
        </h1>
        ...
        <div className="mt-20">
          ...
          <div className="mt-8">
            <span
              className="bg-cyan-500/90 text-black font-bold
              px-8 py-3 rounded-2xl shadow-xl
