...
>
  <div className="max-w-4xl w-full z-10">
    ...
    <div className="text-white/80 text-lg md:text-xl leading-relaxed space-y-6">
      <p>
        Hi, I’m <span className="text-white font-semibold">Harutyun Gevoglanyan</span> — a full-stack developer from Los Angeles who’s passionate about building clean, scalable, and user-friendly web experiences.
      </p>
