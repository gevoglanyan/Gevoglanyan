      ...
      >
        ...
        <div className="text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed space-y-6">
          ...
          <p>
            ...
            , and I’m well-versed in both{" "}
            <span className="text-white font-semibold">MySQL</span> and{" "}
            <span className="text-white font-semibold">MongoDB</span> for
            database solutions. Whether it’s a business site, e-commerce
            platform, or interactive app — I love turning ideas into reality.
          </p>
