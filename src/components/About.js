...
const About = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-12 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
          ABOUT
        </h2>
        ...
        {showResumeNotice && (
          ...
          >
            <motion.div
              className="relative bg-black rounded-3xl p-10 max-w-2xl w-full text-center border border-white/20 shadow-2xl"
            ...
            >
              ...
              <p className="text-gray-300 text-lg leading-relaxed max-w-xl mx-auto">
                To request a downloadable copy of my resume please reach out. <br /> I'm happy to share it upon request.
