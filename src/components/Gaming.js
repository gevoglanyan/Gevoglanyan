  ...
  return (
    ...
    >
      <div className="max-w-4xl w-full z-10">
        ...
        <p className="text-white/80 text-lg md:text-xl leading-relaxed space-y-6">
          <span className="block mb-6">
            I don’t play a lot of different games — just one consistently: <span className="text-white font-semibold">Destiny 2</span>.
          </span>
